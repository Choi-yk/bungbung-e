	...
	public Client() {
		...
		j1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//면허와 보험 가입 사실 확인해야 가입 가능하도록 추가
				if (drivers_license != "있음" || insurance != "가입함" ) {
					JOptionPane.showMessageDialog(null, "운전면허와 보험 가입이 있어야 합니다.");
					result = 0;
				}
				if (result != 0) {
					clientNum += 1;
					result = dao.insertClient(clientNum, clientName, phoneNumber, drivers_license, insurance);
					JOptionPane.showMessageDialog(null, "등록이 완료되었습니다.");
					
				} else {
					JOptionPane.showMessageDialog(null, "등록에 실패했습니다. 다시 확인해주세요");
					t1.setText("");
				}
